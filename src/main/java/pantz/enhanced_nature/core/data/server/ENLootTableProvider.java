    ...
    private static class ENBlockLoot extends BlockLootSubProvider {
        ...
        protected void generate() {
            ...
            for (DeferredBlock<?> block : new DeferredBlock[]{
                    ...
                    SLIME_BRICKS, SLIME_BRICK_STAIRS, SLIME_BRICK_WALL, CHISELED_SLIME_BRICKS,
                    SLIME_TILES, SLIME_TILE_STAIRS, SLIME_TILE_WALL, SLIME_BULB,
                    PEAT, DRIED_PEAT, PEAT_BRICKS, PEAT_BRICK_STAIRS, PEAT_BRICK_WALL, PEAT_TILES, PEAT_TILE_STAIRS, PEAT_TILE_WALL
            }) {
            ...
            for (DeferredBlock<?> block : new DeferredBlock[]{
                    ...
                    PALM_SLAB, PERMAFROST_SLAB, PERMAFROST_BRICK_SLAB, SLIME_BRICK_SLAB, SLIME_TILE_SLAB, PEAT_BRICK_SLAB, PEAT_TILE_SLAB
            }) {
