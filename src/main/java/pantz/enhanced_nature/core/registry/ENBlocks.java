...
public class ENBlocks {
    ...
    public static void setupTabs() {
		CreativeModeTabContentsPopulator.mod(EnhancedNature.MOD_ID)
                ...
                .addItemsBefore(of(Blocks.SANDSTONE), DRIED_PEAT, PEAT_BRICKS, PEAT_BRICK_STAIRS, PEAT_BRICK_SLAB, PEAT_BRICK_WALL)
                .addItemsBefore(modLoaded(Blocks.SANDSTONE, ENConstants.ENVIRONMENTAL), PEAT_TILES, PEAT_TILE_STAIRS, PEAT_TILE_SLAB, PEAT_TILE_WALL)
